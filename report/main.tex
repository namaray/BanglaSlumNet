...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/confidence_strata.png}
    \caption{Weak-label composition across the Dhaka study regions. The chart shows that informal regions contribute slum-labeled built pixels, formal control regions contribute formal-labeled built pixels, and unknown pixels are excluded from supervised loss.}
\end{figure}
